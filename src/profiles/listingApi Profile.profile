<?xml version="1.0" encoding="utf-8"?><Profile xmlns="http://soap.sforce.com/2006/04/metadata"><custom>true</custom><userLicense>Guest User License</userLicense><fieldPermissions>
        ...
        <layout>Financial_Application_Asset__c-Financial Application Asset Layout</layout>
    </layoutAssignments><layoutAssignments>
        <layout>Financial_Application_Asset__c-Financial Application Asset Layout</layout>
        ...
        <layout>Financial_Application_Income__c-Financial Application Income Layout</layout>
    </layoutAssignments><layoutAssignments>
        <layout>Financial_Application_Income__c-Financial Application Income Layout</layout>
        ...
        <layout>Financial_Application__c-Financial Application Layout</layout>
    </layoutAssignments><layoutAssignments>
        <layout>Financial_Application__c-Financial Application Layout</layout>
        ...
        <layout>Housing_Application_Asset__c-Housing Application Asset Layout</layout>
    </layoutAssignments><layoutAssignments>
        <layout>Housing_Application_Asset__c-Housing Application Asset Layout</layout>
        ...
        <layout>Housing_Application_Income__c-Housing Application Income Layout</layout>
    </layoutAssignments><layoutAssignments>
        <layout>Housing_Application_Income__c-Housing Application Income Layout</layout>
        ...
        <layout>Housing_Application__c-Housing Application Layout</layout>
    </layoutAssignments><layoutAssignments>
        <layout>Housing_Application__c-Housing Application Layout</layout>
        ...
        <layout>Loan_Activity__c-Loan Activity Layout</layout>
    </layoutAssignments><layoutAssignments>
        <layout>Loan_Activity__c-Loan Activity Layout</layout>
        ...
        <layout>Personal_Asset__c-Personal Asset Layout</layout>
    </layoutAssignments><layoutAssignments>
        <layout>Personal_Asset__c-Personal Asset Layout</layout>
        ...
        <layout>Personal_Income__c-Personal Income Layout</layout>
    </layoutAssignments><layoutAssignments>
        <layout>Personal_Income__c-Personal Income Layout</layout>
        ...
        <layout>Properties__c-Listing Layout</layout>
    </layoutAssignments><layoutAssignments>
        <layout>Properties__c-Listing Layout</layout>
